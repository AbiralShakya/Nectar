#!/usr/bin/env python3
"""
Simple test script for synthetic thermal experiment (no matplotlib).
...
from src.experiments.run_synthetic_thermal_experiment_simple import SyntheticThermalExperimentSimple
import argparse
import json
from pathlib import Path

def main():
    parser = argparse.ArgumentParser(description="Simple test of synthetic thermal experiment")
    ...
    print("=== Simple Test of Synthetic Thermal Experiment ===")
    ...
    try:
        # Run experiment
        experiment = SyntheticThermalExperimentSimple(test_args)
