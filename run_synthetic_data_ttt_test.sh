...
# Test 2: Dynamic Adaptation Experiment (Power vs Runtime)
echo "=== Step 2: Dynamic Adaptation Experiment ==="
python src/experiments/run_dynamic_adaption.py \
    --num_gpus 1 \
    --num_experts 16 \
    --d_model 768 \
    --output_file "$RESULTS_DIR/dynamic_adaptation_results.json" \
    --save_plots \
| tee "$RESULTS_DIR/dynamic_adaptation.log"

# Test 3: Energy-Aware TTT with Synthetic Data
echo "=== Step 3: Energy-Aware TTT Routing Test ==="
...
for lambda_energy in 0.001 0.01 0.05 0.1 0.2; do
    ...
    python src/experiments/test_energy_aware_ttt_synthetic.py \
...
# Test 4: Thermal-Aware Routing Test
echo "=== Step 4: Thermal-Aware Routing Test ==="
python src/experiments/test_thermal_aware_routing.py \
    --num_gpus 1 \
    --num_experts 16 \
    --batch_size 16 \
    --seq_length 128 \
...
# Test 5: Network Topology Optimization Test
echo "=== Step 5: Network Topology Optimization Test ==="
python src/experiments/test_network_topology.py \
    --num_gpus 1 \
    --num_experts 16 \
    --batch_size 32 \
    --seq_length 256 \
    --d_model 768 \
    --num_batches 75 \
    --placement_strategies "load_balanced,bandwidth_optimized,thermal_aware" \
    --synthetic_data_file "$RESULTS_DIR/synthetic_dataset.json" \
    --output_file "$RESULTS_DIR/network_topology_results.json" \
    --save_plots \
| tee "$RESULTS_DIR/network_topology.log"

# Test 6: Comprehensive TTT Validation
echo "=== Step 6: Comprehensive TTT Validation ==="
...
# Test 7: Error Margin and Noise Analysis
echo "=== Step 7: Error Margin and Noise Analysis ==="
...
echo "  - dynamic_adaptation_results.json: Power vs runtime analysis"
...
echo "  - network_topology_results.json: Topology optimization results"
